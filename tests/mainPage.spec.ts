...
test.describe("группа тестов главной страницы", () => {
  ...
  test("Проверка названий элементов навигаций header", async ({ page }) => {
  ...
  test("Проверка переключения theme", async ({ page }) => {
  ...
  test("Проверка кнопки старт", async ({ page }) => {
